...
基于 answer_curebench_testset1.py（带详细工具使用指南的 prompt）
...
# 来自 answer_curebench_testset1.py 的 SYSTEM_PROMPT
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="使用 OpenRouter API + MCP 工具回答 CureBench Testset 问题 (Prompt1)")
