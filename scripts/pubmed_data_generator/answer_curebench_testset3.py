...
基于 answer_curebench_with_tools3.py（带更详细指南和约束的 prompt）
【增加重复 query 检测】
"""
import asyncio
import json
...
# 来自 answer_curebench_with_tools3.py 的 SYSTEM_PROMPT，增加重复检测提示
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="使用本地模型 + MCP 工具回答 CureBench Testset 问题 (Prompt3 + 重复检测)")
