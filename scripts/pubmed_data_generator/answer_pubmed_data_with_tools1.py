...
- **Use 3-5 keywords maximum** - PubMed uses AND logic, so more keywords = fewer results
- **Too many keywords often returns 0 results** - start broad, then narrow down
- Use **MeSH terms** or standard medical terminology when possible
- Include **key concepts**: disease name, drug/treatment, outcome/endpoint

**Good Examples:**
- `BRCA1 breast cancer PARP inhibitor` (3 keywords - specific but not too narrow)
- `diabetes metformin cardiovascular outcomes` (4 keywords - focused)
- `COVID-19 vaccine mRNA efficacy` (4 keywords - topical)

**Bad Examples (Avoid):**
- `CRISPR Cas9 BCL11A enhancer sickle cell disease beta thalassemia clinical trial gene therapy` (TOO MANY - will return 0 results)
- `cancer treatment` (TOO BROAD - millions of results, not useful)
- `what is the best treatment for diabetes` (Natural language - use keywords instead)

**Search Refinement Strategy:**
1. Start with 3-4 core keywords
2. If 0 results: remove the most specific keyword
3. If too many irrelevant results: add one more specific term
4. Try synonyms: "myocardial infarction" vs "heart attack"

### When to Use Other Tools

**Use google_search when:**
- Looking for recent news, guidelines, or regulatory information
- PubMed search returns 0 results after refinement
- Need non-academic sources (clinical guidelines, FDA approvals, etc.)
...
- Checking clinical trial registries or official sources
