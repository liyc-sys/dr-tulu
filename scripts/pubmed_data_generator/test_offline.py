...
def test_data_structures():
    ...
    papers = [
        ...
        PaperEvidence(
            ...
            abstract="We conducted a comprehensive analysis of BRCA1 mutations and their impact on PARP inhibitor sensitivity. Patients with pathogenic BRCA1 variants showed significantly improved progression-free survival when treated with olaparib compared to standard chemotherapy.",
            year="2023",
        ...
        PaperEvidence(
            ...
            abstract="This phase III trial evaluated the combination of nivolumab and ipilimumab in advanced melanoma. The combination therapy resulted in improved overall survival compared to monotherapy, with a manageable safety profile.",
            year="2023",
